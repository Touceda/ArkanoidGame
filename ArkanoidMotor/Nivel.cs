                ...
                case 1:
                    {
                        ...
                        {new GameObject(Puntos[0,0],Imagenes,0,largo,PWP),new GameObject(Puntos[0,1],Imagenes,1,largo,PWP),new GameObject(Puntos[0,2],Imagenes,1,largo,PWP),new GameObject(Puntos[0,3],Imagenes,1,largo,PWP),new GameObject(Puntos[0,4],Imagenes,1,largo,PWP),new GameObject(Puntos[0,5],Imagenes,1,largo,PWP),new GameObject(Puntos[0,6],Imagenes,1,largo,PWP),new GameObject(Puntos[0,7],Imagenes,1,largo,PWP),new GameObject(Puntos[0,8],Imagenes,1,largo,PWP),new GameObject(Puntos[0,9],Imagenes,1,largo,PWP)},
